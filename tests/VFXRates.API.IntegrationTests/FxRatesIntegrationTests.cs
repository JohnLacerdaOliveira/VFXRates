...
namespace VFXRates.API.IntegrationTests
{
    public class FxRatesIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public async Task GetFxRateByCurrencyPair_ReturnsCorrectRate()
        {
            ...
            var getResponse = await _webClient.GetAsync($"/api/FxRates/{newRate.BaseCurrency}/{newRate.QuoteCurrency}");
        ...
        public async Task PutFxRate_UpdatesExistingRate()
        {
            ...
            // Assert
            var putResponse = await _webClient.PutAsJsonAsync("/api/FxRates", updateDto);
        ...
        public async Task DeleteFxRate_RemovesExistingRate_ButRefetchedIfMissing()
        {
            ...
            var getResponseBeforeDelete = await _webClient.GetAsync($"/api/FxRates/{newRate.BaseCurrency}/{newRate.QuoteCurrency}");
            ...
            // Assert
            var getResponseAfterDelete = await _webClient.GetAsync($"/api/FxRates/{newRate.BaseCurrency}/{newRate.QuoteCurrency}");
