...
namespace VFXRates.Application.UnitTests
{
    public class FxRateServiceTests
    {
        ...
        private readonly Mock<IFxRateRepository> _mockRepo;
        ...
        private readonly Mock<ILogger<FxRateService>> _mockLogger;

        public FxRateServiceTests()
        {
            _mockRepo = new Mock<IFxRateRepository>();
            _mockExchangeRateApiClient = new Mock<IExchangeRateApiClient>();
            _mockRabbitMQPublisher = new Mock<IRabbitMqPublisher>();
            _mockLogger = new Mock<ILogger<FxRateService>>();
        ...
        public async Task GetAllFxRates_ShouldReturnRates_WhenDataExists()
        {
            ...
            {
                new FxRate { BaseCurrency = "EUR", QuoteCurrency = "USD", Bid = 1.1m, Ask = 1.2m },
                new FxRate { BaseCurrency = "GBP", QuoteCurrency = "USD", Bid = 1.3m, Ask = 1.4m },
            };
        ...
        {
            // Arrange
            var existingFxRate = new FxRate { BaseCurrency = "GBP", QuoteCurrency = "USD" };
